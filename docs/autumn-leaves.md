...
<p><select onchange="document.getElementById('music').src = this.value">
  ...
  <option value="https://github.com/darluzmusic/low-brass-studio/raw/master/docs/assets/al03.png">7ths to 3rds</option>
  <option value="https://github.com/darluzmusic/low-brass-studio/raw/master/docs/assets/al04.png">1st 2 Notes</option>
  <option value="https://github.com/darluzmusic/low-brass-studio/raw/master/docs/assets/al05.png">1st 3 Notes</option>
