...
<body onload="selectFunction()">
  <div id="top" style="font-family:Arial, Helvetica, sans-serif">ESSENTIAL ELEMENTS FOR BAND:<br>TUBA BOOK 2</div>
    <div id="exercises">
  ...
  <option>187-199</option>
   </optgroup>
    <optgroup label="Solo">
  <option>200-201</option>
    </optgroup>
</select>
