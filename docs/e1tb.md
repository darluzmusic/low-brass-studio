...
function selectFunction() {
  ...
  for (; i <= num; i++) 
  {
    ...
    text +="<img width="100%" src=" + img_path + zero + i + ".jpg><br><audio controls><source src=" +  aud_path + i + ".mp3></audio><br><hr style="height:10px;border-radius:25px; background-color:#244c4d">";
  }
